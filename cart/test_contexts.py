...
class CartContentsTestCase(TestCase):
    ...
    def setUp(self):
        ...
        self.brand1 = Brand.objects.create(
            name='Test Brand 1', universe='real')
        ...
        self.category2 = Category.objects.create(
            name='Test Category 2', universe='digital', pk=2)
        self.brand2 = Brand.objects.create(
            name='Test Brand 2', universe='digital')
    ...
    def test_cart_contents_a(self):
        ...
        self.assertEqual(
            round(cart_context['delivery'], 2), round(Decimal(7.99), 2))
        self.assertEqual(
            round(cart_context['real_items_total'], 2), Decimal('10.00'))
        self.assertEqual(
    ...
    def test_cart_contents_b(self):
        ...
        self.assertEqual(cart_context['product_count'], 2)
        self.assertEqual(
            round(cart_context['discounted_total'], 2), Decimal('270.00'))
        ...
        self.assertEqual(
            round(cart_context['delivery'], 2), round(Decimal(7.99), 2))
        self.assertEqual(
            round(cart_context['real_items_total'], 2), Decimal('300.00'))
        self.assertEqual(
